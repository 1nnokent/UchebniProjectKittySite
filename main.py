...
def registration_page():
    ...
    if request.method == "GET":
        ...
        if code == 0:
            ...
            return render_template("error_pages/error_registration_user_exists.html", user=user)
        else:
            pass
...
def add_group():
    if request.method == "GET":
        ...
        dr.insert_group(group_id, info["group_name"], info["group_description"], current_user.id)
